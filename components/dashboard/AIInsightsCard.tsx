                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3 w-full sm:w-auto">
                        ...
                        <Button
                            ...
                            disabled={loading}
                            title={loading ? t("dashboard.ai.insights.button.loading") : t("dashboard.ai.insights.button.idle")}
                            className="bg-[#1C1C1C] hover:bg-[#37352f] text-white h-9 px-4 font-medium transition-all flex-shrink-0 flex items-center gap-2"
                        >
                            {loading ? (
                            ...
                            <span className="hidden xl:inline">{loading ? t("dashboard.ai.insights.button.loading") : t("dashboard.ai.insights.button.idle")}</span>
                        </Button>
                    </div>
                </div>
            </CardHeader>
