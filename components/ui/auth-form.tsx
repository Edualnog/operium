...
const GoogleLoginButton: React.FC<{ onClick: () => void; disabled: boolean }> = ({ onClick, disabled }) => (
  <button
    type="button"
    onClick={onClick}
    disabled={disabled}
    className="w-full rounded-md border-2 border-zinc-300 bg-white px-4 py-2.5 text-zinc-700 font-medium
    transition-all hover:bg-zinc-50 hover:border-zinc-400 active:scale-[0.98] 
