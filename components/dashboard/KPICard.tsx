...
export function KPICard({
  ...
  return (
    <Card className="relative overflow-hidden border border-zinc-200 bg-white shadow-sm hover:shadow-xl transition-all duration-300 group">
      ...
      <CardContent className="p-4 sm:p-5 lg:p-5 xl:p-6">
        <div className="flex flex-col gap-3.5">
          ...
          <div className="flex items-start gap-3">
            <div className={`p-2.5 sm:p-3 rounded-xl shadow-sm flex-shrink-0 ${
              variant === "destructive" 
            ...
            <h2 className="text-sm sm:text-base lg:text-lg font-semibold text-zinc-900 leading-snug flex-1 min-w-0">
              {title}
            </h2>
          </div>
          ...
          <div className="flex items-end justify-between gap-3 mt-auto">
            <p className="text-xs sm:text-sm text-zinc-500 flex-1 leading-relaxed">{description}</p>
