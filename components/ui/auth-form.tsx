...
const GoogleLoginButton: React.FC<GoogleLoginButtonProps> = ({ onLogin, loading }) => {
  return (
    <button
      type="button"
      onClick={onLogin}
      disabled={loading}
      className="w-full mb-6 flex items-center justify-center gap-3 rounded-md border border-zinc-300 bg-white px-4 py-3 text-sm font-medium text-zinc-700 shadow-sm transition-all hover:bg-zinc-50 hover:border-zinc-400 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
    >
