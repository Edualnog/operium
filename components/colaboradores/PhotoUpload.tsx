...
export function PhotoUpload({
  ...
  const uploadPhoto = async (file: File) => {
    try {
      ...
      if (uploadError) {
        // Se o bucket não existir, criar automaticamente (via código)
        if (uploadError.message.includes("Bucket not found")) {
          alert(
            "Bucket de fotos não encontrado. Por favor, crie o bucket 'colaboradores-fotos' no Supabase Storage."
          )
          return
        }
        throw uploadError
